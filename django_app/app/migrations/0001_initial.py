# Generated by Django 3.0.2 on 2020-02-14 11:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField()),
                ('uuid', models.UUIDField()),
                ('fk', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='all_models', to='app.AllModel')),
                ('one_to_one', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='all_model', to='app.AllModel')),
            ],
        ),
    ]
